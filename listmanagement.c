//AIM: Write c program for linked list for  following insertion first ,deletion first ,insertion  last ,deletion  last,insertion  random ,deletion  random ,Search ,Update.
/*EXPLANATION:
